...
ARG BUILD_FROM=ghcr.io/home-assistant/base:latest    ## Should swap this link to ghrc.io/docker-base/alpinelinux:3.22, not sure of the link
...
RUN chmod -Rv a+x /etc/s6-overlay/s6-rc.d/** /usr/bin/sbfspot/** /etc/services.d/**
