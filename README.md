...
![Project Maintenance][maintenance-shield] [![CI](https://github.com/habuild/haos-sbfspot/actions/workflows/only-checks-app-ci.yaml/badge.svg)](https://github.com/habuild/haos-sbfspot/actions/workflows/only-checks-app-ci.yaml)
